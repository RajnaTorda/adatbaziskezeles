...
--
-- Gép: 127.0.0.1
-- Létrehozás ideje: 2023. Okt 24. 11:23
...
CREATE TABLE `altalanos_iskola` (
  ...
  `altalanos_iskola_nev` varchar(255) CHARACTER SET utf8 COLLATE utf8_hungarian_ci NOT NULL,
...
INSERT INTO `altalanos_iskola` (`id_altalanos_iskola`, `altalanos_iskola_nev`, `altalanos_iskola_cime`) VALUES
...
ALTER TABLE `jelentkezes`
  ...
  ADD KEY `kozepiskola_id_2` (`kozepiskola_id`),
